...
| Continue highlight across pages                            | Pass                     | Dedicated-vault reader exposes the continuation workflow; anchor integration tests merge both fragments and intervening text into one annotation |
