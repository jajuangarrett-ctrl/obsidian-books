...
noted otherwise, manual results below were recorded in Obsidian 1.13.7 on macOS
...
| Continue highlight across pages                            | Physical device required | The 0.2.3 bundle loads in the dedicated vault; automated integration tests merge both fragments and intervening text into one annotation, while final finger/Pencil feel awaits iPad |
...
| Section table of contents                   | Pass   | Far-right toolbar action listed rendered H1–H6 hierarchy, omitted an embedded-note heading, and jumped to page 6/7 and a vertical-mode heading                                |
...
| Multi-page highlights                       | Pass   | Continuation advances one page at a time, can repeat, preserves the first saved fragment on cancel, and stores the complete passage as one anchor                             |
