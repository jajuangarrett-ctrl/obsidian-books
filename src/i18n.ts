const STRINGS = {
	en: {
		...
		contents: 'Contents',
		sectionContents: 'Section table of contents',
		sectionContentsDescription: 'Headings and subheadings in this chapter.',
		noSectionHeadings: 'No headings or subheadings were found in this chapter.',
	...
	ru: {
		...
		contents: 'Содержание',
		sectionContents: 'Содержание разделов',
		sectionContentsDescription: 'Заголовки и подзаголовки этой главы.',
		noSectionHeadings: 'В этой главе нет заголовков или подзаголовков.',
